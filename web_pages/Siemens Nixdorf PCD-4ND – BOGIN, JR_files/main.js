...
( function( $ ) {
    ...
    function initMainNavigation( container ) {
        ...
        var dropdownToggle = $( '<button />', {
            ...
            text: jojo_screenReaderText.expand
        } ) );
        ...
        container.find( '.dropdown-toggle' ).click( function( e ) {
            ...
            // jscs:enable
            screenReaderSpan.text( screenReaderSpan.text() === jojo_screenReaderText.expand ? jojo_screenReaderText.collapse : jojo_screenReaderText.expand );
        } );
    }
